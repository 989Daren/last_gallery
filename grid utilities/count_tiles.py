...
Shows the breakdown of tile sizes (s, m, lg, xl) in your gallery.
"""
...
def count_tiles_by_size():
    ...
    print("-" * 60)
    print(f"{'Small (s)':<20} {size_counts['S']:<10} {'85 × 85'}")
    print(f"{'Medium (m)':<20} {size_counts['M']:<10} {'170 × 170'}")
    print(f"{'Large (lg)':<20} {size_counts['L']:<10} {'255 × 255'}")
    print(f"{'Extra Large (xl)':<20} {size_counts['XL']:<10} {'340 × 340'}")
    print("-" * 60)
