...
| `templates/privacy.html` | Privacy policy page (standalone, self-styled) |
...
3. **Unlock to Upgrade Your Artwork!** — opens upgrade modal (3-step flow)
4. **A Human Centric Gallery** — opens info modal (see below)
5. **Edit Your Artwork or Exhibit** — opens edit banner
6. **Admin** — opens admin modal (PIN gated)
7. **Your Privacy** — links to `/privacy` page
...
- Info tiles are excluded from shuffle, cleanup, and abandonment logic
